  ...
  return (
    <div className="SignUp-Container">
      <div className='overview'>
        <p>Welcome to ANYWHERE FITNESS. 
          We hope that you enjoy our app and find yourself surrounded by fitness! Joe Anywhere opened the first Gold's Gym in August 1965, in Venice Beach, California, long before the modern day health club existed. Featuring homemade equipment and dubbed "the Mecca of bodybuilding", it was frequented by Arnold Schwarzenegger and Dave Draper and featured in the docudrama Pumping Iron (1977), which brought attention not only to the gym itself but also to bodybuilding and physique in general. To this day, Gold's Gym is considered a landmark in bodybuilding culture and has achieved cult status.
